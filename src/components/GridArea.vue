...
<template>
  <div class="w-full flex-1 flex items-center justify-center p-4 sm:p-0 sm:pt-4fĩ min-h-0 min-w-0">
    <!-- Stream Deck Cyberpunk Shell -->
    <div
      class="cyber-shell relative w-full h-full max-w-2xl flex items-center justify-center overflow-hidden"
    >
      <!-- Scanline overlay -->
      ...
      <span
        class="absolute top-3 left-3 w-5 h-5 border-t-[3px] border-l-[3px] pointer-events-none"
        :style="{ borderColor: 'var(--theme-corner-a)' }"
      />
      <span
        class="absolute top-3 right-3 w-5 h-5 border-t-[3px] border-r-[3px] pointer-events-none"
        :style="{ borderColor: 'var(--theme-corner-b)' }"
      />
      <span
        class="absolute bottom-3 left-3 w-5 h-5 border-b-[3px] border-l-[3px] pointer-events-none"
        :style="{ borderColor: 'var(--theme-corner-b)' }"
      />
      <span
        class="absolute bottom-3 right-3 w-5 h-5 border-b-[3px] border-r-[3px] pointer-events-none"
        :style="{ borderColor: 'var(--theme-corner-a)' }"
      />
